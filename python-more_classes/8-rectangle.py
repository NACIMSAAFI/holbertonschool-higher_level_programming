...
def bigger_or_equal(rect_1, rect_2):
    """
    Compares two rectangles based on their areas and returns
    the rectangle with the larger area or `rect_1`
    ...
    Returns:
        Rectangle: The rectangle with the larger area between
        `rect_1` and `rect_2`,
